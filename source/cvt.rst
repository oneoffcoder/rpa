...
Mathematically, there are 5,616 (:math:`54 \times 13 \times 8`) possible permutations of syllables that may be created using these finite sets of consonants, vowels and tones.
...
However, some words do not have a consonant. Meaning, we have 104 (:math:`13 \times 8`) possible syllables without a consonant. In all, there are 5,720 (:math:`5,616 + 104`) total possible syllables. 

Going further, some words are just vowels. So, actually, there are 5,733 total possible syllables in RPA.
